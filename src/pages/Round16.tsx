                  ...
                  <div className="xJAsxE" style={{top: 'calc(16px)'}}>
                    <div>
                      <div ec-theme="dark" className="sZa2a7 ZXh5zu ZcoRFw wUXOVr">
                        <div className="yTI2ha ZXh5zu">
                          <div className="WwzEVC _1e7mHA">
                            <div className="bIaQo9" ec-theme="dark">3</div>
                            <div className="PEMIMj L2gu7I">
                              <div className="XC1tUh" />
                            </div>
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2201.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2201.png?imwidth=64 2x
                            " alt="Netherl." width="32px" />
                            </div>
                            <div className="PZ9lYl">NED</div>
                          </div>
                        </div>
                      </div>
                      <div className="WGbpug" />
                      <div ec-theme="light" className="sZa2a7 ZXh5zu hU8yP3 iJVC6P PMhDRr wUXOVr">
                        <div className="yTI2ha">
                          <div className="WwzEVC _1e7mHA">
                            <div className="bIaQo9" ec-theme="dark">1</div>
                            <div className="PEMIMj" />
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2209.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2209.png?imwidth=64 2x
                            " alt="USA" width="32px" />
                            </div>
                            <div className="PZ9lYl">USA</div>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div className="wKMz0Z">
                      <span className> PICK SCORE </span>
                    </div>
                  </div>
                  <div className="xJAsxE" style={{top: 'calc(207px)'}}>
                    <div>
                      <div ec-theme="dark" className="sZa2a7 ZXh5zu ZcoRFw wUXOVr">
                        <div className="yTI2ha ZXh5zu">
                          <div className="WwzEVC _1e7mHA">
                            <div className="bIaQo9" ec-theme="dark">2</div>
                            <div className="PEMIMj L2gu7I">
                              <div className="XC1tUh" />
                            </div>
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2768.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2768.png?imwidth=64 2x
                            " alt="Argentina" width="32px" />
                            </div>
                            <div className="PZ9lYl">ARG</div>
                          </div>
                        </div>
                      </div>
                      <div className="WGbpug" />
                      <div ec-theme="light" className="sZa2a7 ZXh5zu hU8yP3 iJVC6P PMhDRr wUXOVr">
                        <div className="yTI2ha">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="PEMIMj" />
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2229.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2229.png?imwidth=64 2x
                            " alt="Australia" width="32px" />
                            </div>
                            <div className="PZ9lYl">AUS</div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div ec-theme="light" className="sZa2a7 ZXh5zu ZcoRFw iJVC6P PMhDRr wUXOVr">
                        <div className="yTI2ha">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="PEMIMj" />
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2241.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2241.png?imwidth=64 2x
                            " alt="Japan" width="32px" />
                            </div>
                            <div className="PZ9lYl">JPN</div>
                          </div>
                        </div>
                      </div>
                      <div className="WGbpug" />
                      <div ec-theme="dark" className="sZa2a7 ZXh5zu hU8yP3 wUXOVr">
                        <div className="yTI2ha ZXh5zu">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/4354.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/4354.png?imwidth=64 2x
                            " alt="Croatia" width="32px" />
                            </div>
                            <div className="PZ9lYl">CRO</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="xJAsxE" style={{top: 'calc(589px)'}}>
                    <div>
                      <div ec-theme="dark" className="sZa2a7 ZXh5zu ZcoRFw wUXOVr">
                        <div className="yTI2ha ZXh5zu">
                          <div className="WwzEVC _1e7mHA">
                            <div className="bIaQo9" ec-theme="dark">4</div>
                            <div className="PEMIMj L2gu7I">
                              <div className="XC1tUh" />
                            </div>
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2235.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2235.png?imwidth=64 2x
                            " alt="Brazil" width="32px" />
                            </div>
                            <div className="PZ9lYl">BRA</div>
                          </div>
                        </div>
                      </div>
                      <div className="WGbpug" />
                      <div ec-theme="light" className="sZa2a7 ZXh5zu hU8yP3 iJVC6P PMhDRr wUXOVr">
                        <div className="yTI2ha">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="PEMIMj" />
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/4391.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/4391.png?imwidth=64 2x
                            " alt="Korea" width="32px" />
                            </div>
                            <div className="PZ9lYl">KOR</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="xJAsxE" style={{top: 'calc(780px)'}}>
                    <div>
                      <div ec-theme="dark" className="sZa2a7 ZXh5zu ZcoRFw wUXOVr">
                        <div className="yTI2ha ZXh5zu">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2208.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2208.png?imwidth=64 2x
                            " alt="England" width="32px" />
                            </div>
                            <div className="PZ9lYl">ENG</div>
                          </div>
                        </div>
                      </div>
                      <div className="WGbpug" />
                      <div ec-theme="light" className="sZa2a7 ZXh5zu hU8yP3 iJVC6P PMhDRr wUXOVr">
                        <div className="yTI2ha">
                          <div className="WwzEVC _1e7mHA">
                            <div className="bIaQo9" ec-theme="dark">0</div>
                            <div className="PEMIMj" />
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/4375.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/4375.png?imwidth=64 2x
                            " alt="Senegal" width="32px" />
                            </div>
                            <div className="PZ9lYl">SEN</div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div ec-theme="dark" className="sZa2a7 ZXh5zu ZcoRFw wUXOVr">
                        <div className="yTI2ha ZXh5zu">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2202.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2202.png?imwidth=64 2x
                            " alt="France" width="32px" />
                            </div>
                            <div className="PZ9lYl">FRA</div>
                          </div>
                        </div>
                      </div>
                      <div className="WGbpug" />
                      <div ec-theme="light" className="sZa2a7 ZXh5zu hU8yP3 iJVC6P PMhDRr wUXOVr">
                        <div className="yTI2ha">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="PEMIMj" />
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2214.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2214.png?imwidth=64 2x
                            " alt="Poland" width="32px" />
                            </div>
                            <div className="PZ9lYl">POL</div>
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div ec-theme="dark" className="sZa2a7 ZXh5zu ZcoRFw wUXOVr">
                        <div className="yTI2ha ZXh5zu">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2779.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2779.png?imwidth=64 2x
                            " alt="Morocco" width="32px" />
                            </div>
                            <div className="PZ9lYl">MAR</div>
                          </div>
                        </div>
                      </div>
                      <div className="WGbpug" />
                      <div ec-theme="light" className="sZa2a7 ZXh5zu hU8yP3 iJVC6P PMhDRr wUXOVr">
                        <div className="yTI2ha">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="PEMIMj" />
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2203.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2203.png?imwidth=64 2x
                            " alt="Spain" width="32px" />
                            </div>
                            <div className="PZ9lYl">ESP</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="xJAsxE" style={{top: 'calc(1353px)'}}>
                    <div>
                      <div ec-theme="dark" className="sZa2a7 ZXh5zu ZcoRFw wUXOVr">
                        <div className="yTI2ha ZXh5zu">
                          <div className="WwzEVC _1e7mHA">
                            <div className="bIaQo9" ec-theme="dark">6</div>
                            <div className="PEMIMj L2gu7I">
                              <div className="XC1tUh" />
                            </div>
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2223.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2223.png?imwidth=64 2x
                            " alt="Portugal" width="32px" />
                            </div>
                            <div className="PZ9lYl">POR</div>
                          </div>
                        </div>
                      </div>
                      <div className="WGbpug" />
                      <div ec-theme="light" className="sZa2a7 ZXh5zu hU8yP3 iJVC6P PMhDRr wUXOVr">
                        <div className="yTI2ha">
                          <div className="WwzEVC _1e7mHA">
                            ...
                            <div className="PEMIMj" />
                            <div className="HE3mn_">
                              <img className="HE3mn_" src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2213.png?imwidth=32" srcSet="
                              https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2213.png?imwidth=64 2x
                            " alt="Switzerl." width="32px" />
                            </div>
                            <div className="PZ9lYl">SUI</div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="_EcIvP">
                  <div className="xJAsxE" style={{top: '685px'}}>
                    <div className="_8LXcMX">
                      <div className="IyNWxu _5seon3">
                        <div className="Yvbtm3">
                          <span> YOUR WINNER </span>
                        </div>
                        <div className="zY0XXi">
                          <div className="v5wHIg">
                            <img src="https://images.sports.gracenote.com/images/lib/basic/geo/country/flag/large/2768.png?imwidth=70" srcSet="
